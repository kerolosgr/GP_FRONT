...
const GithubrepocardSkeleton = ()=>{
    return(
        <div className="w-full md:w-[450px] h-[170px] md:h-[150px] p-4 flex flex-col md:flex-row flex-shrink-0 justify-start items-start rounded-lg border border-gray-300">
