const PaperCard = ({title,author,date})=>{
    return(
        <>
        <div className="flex flex-col justify-start items-start w-full md:w-[320px] min-h-[200px] p-4 rounded-xl border-2 hover:shadow transition duration-200 ease-in-out">
