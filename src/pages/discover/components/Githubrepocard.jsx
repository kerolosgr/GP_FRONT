...
const Githubrepocard = ({repoName,repoLanguage,repoDate,repoUrl})=>{
    return(
        <div className="w-full h-[150px] my-1 p-4 flex flex-shrink-0 justify-start items-start rounded-lg border border-gray-300">
            <div className="flex flex-col justify-start items-start w-[80%] h-full">
            <h4 className="text-[21px] font-semibold text-neutral-700">{repoName}</h4>
            <span className="flex items-center mt-2 gap-1.5">
                <span className="block w-[10px] h-[10px] outline-2 outline-neutral-900 rounded-[50%]"></span>
            ...
            <div className="flex flex-col justify-start items-start w-[20%] h-full">
