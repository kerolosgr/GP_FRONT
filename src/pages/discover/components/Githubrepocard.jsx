...
const Githubrepocard = ({repoName,repoLanguage,repoDate,repoUrl})=>{
    ...
    return(
        <div className="w-full md:w-[430px] h-[170px] md:h-[150px] my-1 p-4 flex flex-col md:flex-row flex-shrink-0 justify-start items-start rounded-lg border border-gray-300">
            <div className="flex flex-col justify-start items-start w-full md:w-[68%] h-full">
            ...
            <div className="flex flex-col justify-start items-start w-[32%] h-full">
