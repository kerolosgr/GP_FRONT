...
const CourseCard = ({title,author,platform,description,rating,image_url,url})=>{
    ...
    return(
        ...
        <Dialog open={isVisible} onOpenChange={setisVisible}>
            <DialogContent className="min-w-[1020px] min-h-fit max-h-[80vh]">
                ...
                <p className="text-[14px] font-semibold text-gray-700">{author}</p>
                <p className="text-[13px] font-semibold text-gray-900">{platform}</p>
